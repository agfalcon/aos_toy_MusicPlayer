...
class MediaPlayerService : Service() {
    ...
    override fun onCreate() {
        ...
        val pausePendingIntent = PendingIntent.getService(baseContext, 0,
            Intent(baseContext, MediaPlayerService::class.java)
                .apply{
        ...
        val playPendingIntent = PendingIntent.getService(baseContext, 0,
            Intent(baseContext, MediaPlayerService::class.java)
                .apply{
        ...
        val stopPendingIntent = PendingIntent.getService(baseContext, 0,
            Intent(baseContext, MediaPlayerService::class.java)
                .apply{
    ...
    override fun onStartCommand(intent: Intent?, flags: Int, startId: Int): Int {
        when(intent?.action){
            MEDIA_PLAYER_PLAY -> {
                if(mediaPlayer == null){
                    mediaPlayer = MediaPlayer.create(baseContext, R.raw.brocoli)
                }
                mediaPlayer?.start()
            }
            MEDIA_PLAYER_PAUSE -> {
